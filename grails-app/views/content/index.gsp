...
<html>
    ...
    <div id="content" role="main">
        <div class="container-fluid">
            ...
            <section class="row">
                <div id="list-content" class="col-12 content scaffold-list" role="main">
                    <h1><g:message code="default.list.label" args="[entityName]" /></h1>
                    <g:if test="${flash.message}">
                        <div class="message" role="status">${flash.message}</div>
                    </g:if>
                    <f:table collection="${contentList}" properties="id, source, title, description, dateCreated" />

                    <g:if test="${contentCount > params.int('max')}">
