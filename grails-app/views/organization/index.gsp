...
<html>
    <head>
        ...
        <g:set var="entityName" value="${message(code: 'organization.text', default: 'Organization')}" />
    ...
    <div id="content" role="main">
        <div class="container-fluid">
            ...
            <section class="row">
                <div id="list-organization" class="col-12 content scaffold-list" role="main">
                    ...
                    <g:if test="${organizationCount > params.int('max')}">
