        ...
        <section class="row content-structure">
            ...
            <div class="card col-md-3 mb-4">
                <div class="card-body">
                    ...
                    <span class="card-text">(${Concept.count()})</span>
                    <ul>
                        <g:each in="${Concept.list(max: 15)}" status="i" var="it">
                            <li>
            ...
            <div class="card col-md-3 mb-4">
                <div class="card-body">
                    ...
                    <span class="card-text">(${ThingType.count()})</span>
                    <ul>
                        <g:each in="${ThingType.list(max: 15)}" status="i" var="it">
                            <li>
...
%{--                    <span class="card-text">(${Vocabulary.count()})</span>--}%
%{--                    <ul>--}%
%{--                        <g:each in="${Vocabulary.list(max: 15)}" status="i" var="it">--}%
%{--                            <li>--}%
...
%{--                    <span class="card-text">(${Term.count()})</span>--}%
%{--                    <ul>--}%
%{--                        <g:each in="${Term.list(max: 15)}" status="i" var="it">--}%
%{--                            <li>--}%
...
%{--                    <span class="card-text">(${Statement.count()})</span>--}%
%{--                    <ul>--}%
%{--                        <g:each in="${Statement.list(max: 15)}" status="i" var="it">--}%
%{--                            <li>--}%
...
%{--                    <span class="card-text">(${Tag.count()})</span>--}%
%{--                    <ul>--}%
%{--                        <g:each in="${Tag.list(max: 15)}" status="i" var="it">--}%
%{--                            <li>--}%
...
%{--                <div class="card-body">--}%
%{--                    <span><asset:image src="question.svg" alt="Documents" class="icon"/></span>--}%
%{--                    <span class="card-title">Content/Docs</span>--}%
%{--                    <span class="card-text">(${Content.count()})</span>--}%
%{--                    <ul>--}%
%{--                        <g:each in="${Content.list(max: 15)}" status="i" var="it">--}%
%{--                            <li>--}%
%{--                                <g:link controller="content" action="show" id="${it.id}"--}%
%{--                                        title="${i + 1}: ${it.uri ?: 'unknown uri'}">${it.title}</g:link>--}%
%{--                            </li>--}%
%{--                        </g:each>--}%
%{--                    </ul>--}%
%{--                    <g:link controller="content" class="btn btn-primary">Docs</g:link>--}%
%{--                </div>--}%
%{--            </div>--}%
