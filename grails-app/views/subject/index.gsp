...
<html>
    ...
    <div id="content" role="main">
        <div class="container-fluid">
            ...
            <section class="row">
                <div id="list-subject" class="col-12 content scaffold-list" role="main">
                    <h1><g:message code="default.list.label" args="[entityName]" /></h1>
                    <g:if test="${flash.message}">
                        <div class="message" role="status">${flash.message}</div>
                    </g:if>
                    <f:table collection="${subjectList}" properties="label, description, subSubjects, topics, concepts"/>
